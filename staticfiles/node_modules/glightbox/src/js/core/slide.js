...
import ZoomImages from 'glightbox/src/js/core/zoom.js';
import DragSlides from 'glightbox/src/js/core/drag.js';
import slideImage from 'glightbox/src/js/slides/image.js';
import slideVideo from 'glightbox/src/js/slides/video.js';
import slideInline from 'glightbox/src/js/slides/inline.js';
import slideIframe from 'glightbox/src/js/slides/iframe.js';
import SlideConfigParser from 'glightbox/src/js/core/slide-parser.js';
import { addEvent, addClass, removeClass, hasClass, closest, isMobile, isFunction, isNode, createHTML } from 'glightbox/src/js/utils/helpers.js';
