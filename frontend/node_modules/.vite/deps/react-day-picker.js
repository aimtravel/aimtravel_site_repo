...
function DayButton(props) {
  ...
  return import_react4.default.createElement("button", { ref, ...buttonProps });
}
...
function DayPicker(initialProps) {
  ...
  const { components, formatters, labels, dateLib, locale, classNames } = (0, import_react31.useMemo)(() => {
