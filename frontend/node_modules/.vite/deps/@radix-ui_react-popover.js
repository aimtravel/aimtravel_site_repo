...
var Arrow = React2.forwardRef(
  __name(function Arrow2(props, forwardedRef) {
...
var Popper = __name3((props) => {
  const { __scopePopper, children } = props;
  const [anchor, setAnchor] = React4.useState(null);
  const [placementState, setPlacementState] = React4.useState(void 0);
...
var PopperAnchor = React4.forwardRef(
  __name3(function PopperAnchor2(props, forwardedRef) {
    const { __scopePopper, virtualRef, ...anchorProps } = props;
    const context = usePopperContext(ANCHOR_NAME, __scopePopper);
    const ref = React4.useRef(null);
    const onAnchorChange = context.onAnchorChange;
    const callbackRef = React4.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
...
var PopperContent = React4.forwardRef(
  __name3(function PopperContent2(props, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name3((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name3(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React4.forwardRef(
  __name3(function PopperArrow2(props, forwardedRef) {
...
__name3(isNotNull, "isNotNull");
var transformOrigin = __name3((options) => ({
...
__name3(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root2 = Popper;
...
var PopoverAnchor = React5.forwardRef(
  __name4(function PopoverAnchor2(props, forwardedRef) {
...
var PopoverTrigger = React5.forwardRef(
  __name4(function PopoverTrigger2(props, forwardedRef) {
...
var PopoverPortal = __name4((props) => {
...
var PopoverContent = React5.forwardRef(
  ...
  __name4(function PopoverContent2(props, forwardedRef) {
...
var PopoverContentModal = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function PopoverContentModal2(props, forwardedRef) {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
    ...
    return (0, import_jsx_runtime3.jsx)(Combination_default, { as: Slot, allowPinchZoom: true, children: (0, import_jsx_runtime3.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverContentNonModal = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function PopoverContentNonModal2(props, forwardedRef) {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
...
var PopoverContentImpl = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function PopoverContentImpl2(props, forwardedRef) {
    const {
      __scopePopover,
      trapFocus,
      onOpenAutoFocus,
...
var PopoverClose = React5.forwardRef(
  __name4(function PopoverClose2(props, forwardedRef) {
...
var PopoverArrow = React5.forwardRef(
  __name4(function PopoverArrow2(props, forwardedRef) {
    const { __scopePopover, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopePopover);
    return (0, import_jsx_runtime3.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "PopoverArrow")
);
function getState(open) {
  return open ? "open" : "closed";
}
__name4(getState, "getState");
var Root22 = Popover;
