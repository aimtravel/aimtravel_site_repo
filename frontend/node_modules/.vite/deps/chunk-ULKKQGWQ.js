...
} from "./chunk-FNF3GN2T.js";
import {
  require_jsx_runtime
} from "./chunk-S725DACQ.js";
import {
  useComposedRefs
} from "./chunk-UY32ETV6.js";
import {
  require_react_dom
...
__name3(useCallbackRef, "useCallbackRef");
...
var DismissableLayer = React3.forwardRef(
  ...
  __name4(function DismissableLayer2(props, forwardedRef) {
    const {
    ...
    const isDeferredPointerDownOutsideRef = React3.useRef(false);
    const pointerDownOutside = usePointerDownOutside(
      ...
      },
      {
        ...
        shouldHandlePointerDownOutside: React3.useCallback(
          (target) => {
    ...
    React3.useEffect(() => {
      const handleUpdate = __name4(() => force({}), "handleUpdate");
...
var DismissableLayerBranch = React3.forwardRef(__name4(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React3.useContext(DismissableLayerContext);
...
__name4(useDismissableLayerSurface, "useDismissableLayerSurface");
var IS_TRUE = __name4(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  const isPointerDownOutsideRef = React3.useRef(false);
  const interceptedOutsideInteractionEventsRef = React3.useRef(/* @__PURE__ */ new Map());
  ...
  React3.useEffect(() => {
    ...
    __name4(resetOutsideInteraction, "resetOutsideInteraction");
    function isOutsideInteractionIntercepted() {
      return Array.from(interceptedOutsideInteractionEventsRef.current.values()).some(Boolean);
    }
    __name4(isOutsideInteractionIntercepted, "isOutsideInteractionIntercepted");
    ...
    __name4(handleInteractionCapture, "handleInteractionCapture");
    function handleInteractionBubble(event) {
      if (isPointerDownOutsideRef.current) {
        interceptedOutsideInteractionEventsRef.current.set(event.type, false);
      }
    }
    __name4(handleInteractionBubble, "handleInteractionBubble");
    const handlePointerDown = __name4((event) => {
      if (event.target && !isPointerInsideReactTreeRef.current) {
        ...
        __name4(handleAndDispatchPointerDownOutsideEvent2, "handleAndDispatchPointerDownOutsideEvent");
  ...
  return {
    ...
    onPointerDownCapture: __name4(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture")
  };
}
__name4(usePointerDownOutside, "usePointerDownOutside");
function useFocusOutside(onFocusOutside, ownerDocument = globalThis == null ? void 0 : globalThis.document) {
  const handleFocusOutside = useCallbackRef(onFocusOutside);
  const isFocusInsideReactTreeRef = React3.useRef(false);
  React3.useEffect(() => {
    const handleFocus = __name4((event) => {
  ...
  return {
    onFocusCapture: __name4(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
    onBlurCapture: __name4(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
  };
}
__name4(useFocusOutside, "useFocusOutside");
function dispatchUpdate() {
  const event = new CustomEvent(CONTEXT_UPDATE);
  document.dispatchEvent(event);
}
__name4(dispatchUpdate, "dispatchUpdate");
...
__name4(handleAndDispatchCustomEvent, "handleAndDispatchCustomEvent");
...
__name5(FocusGuards, "FocusGuards");
...
__name5(useFocusGuards, "useFocusGuards");
...
__name5(createFocusGuard, "createFocusGuard");
...
var FocusScope = React5.forwardRef(
  __name6(function FocusScope2(props, forwardedRef) {
    const {
      loop = false,
      trapped = false,
    ...
    React5.useEffect(() => {
      if (trapped) {
        ...
        __name6(handleFocusIn2, "handleFocusIn");
        __name6(handleFocusOut2, "handleFocusOut");
        __name6(handleMutations2, "handleMutations");
...
__name6(getTabbableEdges, "getTabbableEdges");
function getTabbableCandidates(container) {
  const nodes = [];
  const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, {
    acceptNode: __name6((node) => {
...
__name6(getTabbableCandidates, "getTabbableCandidates");
...
__name6(findVisible, "findVisible");
...
__name6(isHidden, "isHidden");
function isSelectableInput(element) {
  return element instanceof HTMLInputElement && "select" in element;
}
__name6(isSelectableInput, "isSelectableInput");
...
__name6(createFocusScopesStack, "createFocusScopesStack");
...
__name6(arrayRemove, "arrayRemove");
function removeLinks(items) {
  return items.filter((item) => item.tagName !== "A");
}
__name6(removeLinks, "removeLinks");
...
var Portal = React8.forwardRef(
  __name8(function Portal2(props, forwardedRef) {
    var _a;
    const { container: containerProp, ...portalProps } = props;
    const [mounted, setMounted] = React8.useState(false);
    useLayoutEffect2(() => setMounted(true), []);
    const container = containerProp || mounted && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body);
    return container ? ReactDOM.createPortal((0, import_jsx_runtime4.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
  }, "Portal")
);
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name9((event) => {
      ...
      const handleAnimationStart = __name9((event) => {
...
__name9(getElementRef, "getElementRef");
...
__name10(useEffectEvent, "useEffectEvent");
...
__name11(useControllableState, "useControllableState");
...
__name11(useUncontrolledState, "useUncontrolledState");
function isFunction(value) {
  return typeof value === "function";
}
__name11(isFunction, "isFunction");
...
//# sourceMappingURL=chunk-ULKKQGWQ.js.map
